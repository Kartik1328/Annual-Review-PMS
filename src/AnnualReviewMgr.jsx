    ...
    const handleAddRow = () => {
      ...
      const handleSubmit = () => {
          axios.post("http://localhost:8080/api/postByAnnRev", annRevValues)
            .then((response) => {
              axios.get("http://localhost:8080/api/getByAnnual/1")
                .then((response) => setAnnRevValues(response.data))
            })
        
        setSubmitted("You have successfully given Annual Review");
    ...
    <div className='w-full h-screen bg-gray-200'>
      ...
      {/* <h1 className='text-xl font-normal text-black pl-4 pt-10'>Quarter 4</h1> */}
        ...
        <div className='grid grid-cols-10 ml-5'>
          ...
          <textarea type="text" placeholder="Enter here" className=' placeholder-gray-400 overflow-hidden resize-none w-[80%] h-[100px] font-extralight text-normal text-gray-600 -ml-0 pt-2 border-[1px] border-gray-300 p-1 mt-3'value={annRevValues.appraiseComment} /> 
          </div>

          <div className='col-span-2  mt-5 '>
          <h2 className={`text-lg ${index !== 0 && 'hidden'}`}>Manager Comment</h2>
          <textarea type="text" placeholder="Enter here" className=' placeholder-gray-400 overflow-hidden resize-none w-[80%] h-[100px] font-extralight text-normal text-gray-600 -ml-0 pt-2 border-[1px] border-gray-300 p-1 mt-3' name='managerComment' onChange={handleAnnRevValueChange} value={annRevValues.managerComment}/>
          </div>

          <div className='col-span-2  mt-5 '>
          <h2 className={`text-lg ${index !== 0 && 'hidden'}`}>Strength</h2>
          <textarea type="text" placeholder="Enter here" className=' placeholder-gray-400 overflow-hidden resize-none w-[80%] h-[100px] font-extralight text-normal text-gray-600 -ml-0 pt-2 border-[1px] border-gray-300 p-1 mt-3' name='appraiseeStrength' onChange={handleAnnRevValueChange} value={annRevValues.appraiseeStrength} />
          </div>

          <div className='col-span-2   mt-5'>
          <h2 className={`text-lg ${index !== 0 && 'hidden'}`}>Area of imporvement</h2>
          <textarea type="text" placeholder="Enter here" className=' placeholder-gray-400 overflow-hidden resize-none w-[80%] h-[100px] font-extralight text-normal text-gray-600 -ml-0 pt-2 border-[1px] border-gray-300 p-1 mt-3'name='areaOfImprovement' onChange={handleAnnRevValueChange} value={annRevValues.areaOfImprovement}/>
          </div>
          ...
          <textarea type="text" placeholder="Enter here" className=' placeholder-gray-400 overflow-hidden resize-none w-[35%] h-[50px] font-extralight text-normal text-gray-600 pt-2 border-[1px] border-gray-300' name='ratings' onChange={handleAnnRevValueChange} value={annRevValues.ratings}/>
...
export default AnnualReviewMgr
