      ...
      {/* <h1 className='text-xl font-normal text-black pl-4 pt-10'>Quarter 4</h1> */}
        ...
        <div className='text-gray-400 pl-1'>
          <div className="relative">
            ...
            <li><button onClick={() => moveToggle(0)} className="text-lg">Goal Setting</button></li>
            <li><button onClick={() => moveToggle(1)} className="text-lg">Self Assessment</button></li>
            <li><button onClick={() => moveToggle(2)} className="text-lg">Manager Assessment</button></li>
            <li><button onClick={() => moveToggle(2)} className="text-lg">Annual Review</button></li>
            </ul>
          </div>
        </div>
